...
class YandexImages(object):
    def __init__(self):
        ...
        self.skills = '848af041-febd-4cf6-9afc-2460a22eaa64'
...
#yandex = YandexImages()
#yandex.set_auth_token(token='y0_AgAAAAA5tHjAAAT7owAAAADkO7ycqW0gtWLZR46gTf6ETw6fBP3UdvA')
#yandex.skills = '848af041-febd-4cf6-9afc-2460a22eaa64'
